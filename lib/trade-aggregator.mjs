 ...
 * Thresholds from literature + industry practice.
 */
export function classifyTradeNotional(price, qty) {
  const notional = price * qty;
  if (notional >= 100000) return 'whale';
...
export class TradeAggregator {
  ...
  _aggregate() {
    ...
    const sizeVol = { small: 0, medium: 0, large: 0, whale: 0 };
    const sizeCnt = { small: 0, medium: 0, large: 0, whale: 0 };
