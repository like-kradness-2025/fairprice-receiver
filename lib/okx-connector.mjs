      ...
      for (let attempt = 0; attempt < 3; attempt++) {
        try {
          ...
          if (snapshot.data && snapshot.data.length > 0) {
            ...
            this.book.applySnapshot(sbids, sasks, snapshot.seqId || 0);
            this._emitDepth('snapshot', sbids, sasks, Date.now(), snapshot.seqId || 0);
            this._notifyWsSnapshotReceived(snapshot.seqId || 0);
            restored = true;
          }
          break;
        } catch (restErr) {
